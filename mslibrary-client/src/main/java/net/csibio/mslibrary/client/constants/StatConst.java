...
public class StatConst {
    ...
    public static String STAT_HMDB_GENE_NUM = "HMDBGeneNum";
    public static String STAT_HMDB_PROTEIN_NUM = "HMDBProteinNum";
    public static String STAT_HMDB_COMPOUND_NUM = "HMDBCompoundNum";

    public static String STAT_UNIPROT_GENE_NUM = "UniprotGeneNum";
    public static String STAT_UNIPROT_PROTEIN_NUM = "UniprotProteinNum";
